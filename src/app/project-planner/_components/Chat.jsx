...
//
//             try {
//                 const response = await invokeBedrockAgent1(input, generateSessionId());
...
//                         <div key={index} className={`mb-2 p-2 rounded-md ${message.sender === 'user' ? 'bg-blue-500 text-white self-end' : 'bg-gray-300 text-black self-start'}`}>
//                             {message.text}
//                         </div>
//                     ))}
//                 </div>
